...
# Aenean leo magna, vestibulum et tincidunt fermentum, consectetur quis velit. Sed non placerat mas
# sa. Integer est nunc, pulvinar a tempor et, bibendum id arcu. Vestibulum ante ipsum primis in fau
# cibus orci luctus et ultrices posuere cubilia curae; Cras eget scelerisque
def lettings_index(request):
    """
    lettings_index view
    :param request:
    :return: template lettings_index.html
    """
